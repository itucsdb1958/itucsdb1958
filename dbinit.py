...
INIT_STATEMENTS = [
    ...
    """CREATE TABLE IF NOT EXISTS TEAM(
        ...
        COMPETITON_ID INTEGER REFERENCES COMPETITION(ID) ON DELETE SET NULL ON UPDATE CASCADE
    )
    """,
    ...
    """CREATE TABLE IF NOT EXISTS DESIGN(
        ...
        TEAM_ID INTEGER REFERENCES TEAM(ID) ON DELETE SET NULL ON UPDATE CASCADE,
        STATUS_ID INTEGER REFERENCES STATUS(ID) ON DELETE SET NULL ON UPDATE CASCADE,
        TYPE_OF_VEHICLE INTEGER REFERENCES VEHICLE(ID) ON DELETE SET NULL ON UPDATE CASCADE
    )
    """,
