...
INIT_STATEMENTS = [
    ...
    """CREATE TABLE IF NOT EXISTS TEAM(
        ...
        COMPETITON_ID INTEGER REFERENCE COMPETITION(ID) ON DELETE SET NULL ON UPDATE CASCADE
    )
    """,
    """CREATE TABLE IF NOT EXISTS SUBTEAM(
        ID SERIAL PRIMARY KEY,
        NAME VARCHAR NOT NULL,
        TEAM_ID INTEGER REFERENCE TEAM(ID) ON DELETE SET NULL ON UPDATE CASCADE
    )
    """,
    ...
    """CREATE TABLE IF NOT EXISTS PERSON(
        ...
        TEAM_ID INTEGER REFERENCE TEAM(ID) ON DELETE SET NULL ON UPDATE CASCADE
        SUBTEAM_ID INTEGER REFERENCE SUBTEAM(ID) ON DELETE SET NULL ON UPDATE CASCADE
        MAJOR_ID INTEGER REFERENCE MAJOR(ID) ON DELETE SET NULL ON UPDATE CASCADE
        STATUS_ID INTEGER REFERENCE STATUS(ID) ON DELETE SET NULL ON UPDATE CASCADE
    )
    """,
    ...
    """CREATE TABLE IF NOT EXISTS DESIGN(
        ...
        TEAM_ID INTEGER REFERENCE TEAM(ID) ON DELETE SET NULL ON UPDATE CASCADE
        STATUS_ID INTEGER REFERENCE STATUS(ID) ON DELETE SET NULL ON UPDATE CASCADE
        TYPE_OF_VEHICLE INTEGER REFERENCE VEHICLE(ID) ON DELETE SET NULL ON UPDATE CASCADE
    )
    """,
